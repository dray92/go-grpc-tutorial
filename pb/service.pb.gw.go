...
// doesn't go through the normal gRPC flow (creating a gRPC client.go etc.) then it will be up to the passed in
...
var (
	pattern_HelloService_Hello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"v1", "example", "hello", "id", "msg"}, ""))
)
